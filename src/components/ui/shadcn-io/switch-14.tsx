...
const LanguageToggle = ({ language, onChange }: LanguageToggleProps) => {
  ...
  return (
    <div className="flex items-center">
      <div className="relative inline-grid h-10 w-20 grid-cols-[1fr_1fr] items-center text-sm ">
        <Switch
          checked={isPl}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className={cn(
                "relative z-20 flex h-full items-center font-bold justify-center cursor-pointer transition-colors duration-300",
                language === "pl"
              ...
              onClick={() => onChange("pl")}
            >
              <span className="text-[10px] font-bold uppercase">PL</span>
            </div>
          </TooltipTrigger>
          <TooltipContent>
            <p>{t.tooltips.pl}</p>
